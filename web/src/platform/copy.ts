...
export const PLATFORM_COPY = {
  ar: {
    ...
    waPreview: 'عرض جديد على مشروعك P-2001 في ترميم: قدّم مؤسسة البناء المتقن عرضًا بقيمة 52,000 ريال خلال 30 يوم. قارن العروض واقبل ما يناسبك حين تكون جاهزًا. [قارن العروض]',
  ...
  en: {
    ...
    waPreview: 'New bid on your project P-2001 on Tarmem: Build Co bid SAR 52,000 for 30 days. Compare the bids and accept one when you are ready. [Compare the bids]',
