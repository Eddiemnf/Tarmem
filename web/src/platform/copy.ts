...
export const PLATFORM_COPY = {
  ar: {
    ...
    waPreview: 'تحديث على مشروعك في منصة ترميم: عرض جديد على مشروعك P-2001 — مؤسسة البناء المتقن قدّم عرضًا بقيمة 52,000 ريال خلال 30 يوم. اضغط على الزر أدناه لعرض التفاصيل في حسابك. [افتح]',
  ...
  en: {
    ...
    waPreview: 'An update on your project on Tarmem: New bid on your project P-2001 — Build Co bid SAR 52,000, 30 days. Tap the button below to see the details in your account. [Open]',
