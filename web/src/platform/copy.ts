...
export const PLATFORM_COPY = {
  ar: {
    ...
    waPreview: 'تحديث على مشروعك رقم P-2001 في ترميم: وصل عطاء جديد من مؤسسة البناء المتقن بقيمة 52,000 ريال ومدة تنفيذ 30 يوم. تفاصيل العطاء وباقي العطاءات في صفحة المشروع. [افتح المشروع]',
  ...
  en: {
    ...
    waPreview: 'Update on your project P-2001 on Tarmem: a new bid arrived from Build Co, SAR 52,000, 30 days. The details and the other bids are on the project page. [Open the project]',
