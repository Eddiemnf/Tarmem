...
export default function ContractorDashboardPage({ vm }: { vm: VM }) {
  return (<>
    ...
    {vm.qaWorkN ? (<><span className="qa-b">{vm.qaWorkN}</span></>) : null}
        ...
        {vm.launch && !vm.accounts ? null : (<button type="button" className="qa-t" data-route="contractor" data-id="c1" onClick={vm.go}>
        ...
        {vm.launch && !vm.wallet ? null : (<button type="button" className="qa-t" data-route="wallet" onClick={vm.go}>
